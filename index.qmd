...
subtitle: "Using 250 days of data to design your weekly schedule"
format:
  html:
    toc: true
...
1. What the 250 days of data actually look like.
...
## 2.1 All 250 data points in one view

This figure shows **every day** in the data (all 250 points), colored by your presence and arranged by shop.

```{python}
#| label: fig-all-points
#| fig-cap: "All 250 days: one dot per day, colored by your presence"
...
- Spend **Monday–Wednesday** at the **highest-boost shop**.
- Spend **Thursday–Friday** at the **second-highest-boost shop**.
