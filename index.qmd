...
In your data, those top two shops are **Shop 4** and **Shop 2**: when you are present, they fix about **13** and **10** more cars per day than when you are away.
...
fig, axes = plt.subplots(1, len(shops), figsize=(6.5, 4), sharey=True)
...
fig, axes = plt.subplots(1, n_shops, figsize=(6.5, 4), sharey=True)
if n_shops == 1:
    axes = [axes]
...
#| fig-cap: "Estimated extra cars/day when you are present, with uncertainty bars"
...
- A big shift in demand (seasonality, economy, new competitors).
- Major staff changes or turnover in any shop.
- Changes in pricing or in your profit per car.
